...
- [x] **Server accessible** from my domain: [https://fridgemate.click](https://fridgemate.click) - I updated my server files and made sure that going to the domain will open my website, and that the connection is https rather than http
